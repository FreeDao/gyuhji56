...
public class CopyOfSlowMerge3 {
	...
	public static void main(String[] args) throws Exception {
		for(int var = 3; ;var = var + 2){
			System.out.println("var=" + var);
			File f1 = new File("E:\\00-beming\\xxxxxx"+var+".txt");
			File f2 = new File("E:\\00-beming\\xxxxxx"+(var+1)+".txt");
			File f3 = new File("E:\\00-beming\\xxxxxx"+(var+2)+".txt");
			{
				MRTool.sortFile(f2, f1, VVR.class, new Comparator<MRecord>(){
			...
			RecordReader rr = new RecordReader(f2, VVR.class);

			lw = new LineWriter(f3, false);
			for(int x = 0; x < 15; x ++){
				dox(x, rr);
				System.gc();
			}
