...
public class Areas {
	...
	public class AreaSegment extends Segment {
		...
		public TokenHandler segment(String paramString, boolean paramBoolean) {
			...
			if (paramBoolean)
				localTokenHandler = Segment.segment(paramString,
						this.mapReverse, paramBoolean);
			else
				localTokenHandler = Segment.segment(paramString, this.map,
						paramBoolean);
	...
	private Areas() {
		try {
			...
			BmtLogger.log.warn(e, "loading areas failure");
			e.printStackTrace();
		}
