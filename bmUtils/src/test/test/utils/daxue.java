...
public class daxue {
	...
	public void crawl() throws IOException {
		...
		IteratorableCrawler crl = new IteratorableCrawler(mdirx, gen, 3000, 3000); 
	...
	public  void extract(String html, LineWriter lw) throws Exception{
		...
		NodeList nl2 = nl.extractAllNodesThatMatch(new HasAttributeFilter("bgcolor", "C5D5C5"), true);
		//		System.out.println(nl2.size());
		NodeList urls = nl2.extractAllNodesThatMatch(new TagNameFilter("a"), true);
