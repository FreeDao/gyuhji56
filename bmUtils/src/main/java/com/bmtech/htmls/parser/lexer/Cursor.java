...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/lexer/Cursor.java,v $
// $Author: liying $
...
import com.bmtech.htmls.parser.util.sort.Ordered;

/**
 * A bookmark in a page. This class remembers the page it came from and its
...
public class Cursor implements Serializable, Ordered, Cloneable {
	 ...
	 * 
	 * @return The new cursor positioned where <code>this</code> one is, and
	 ...
	 *         r is the row (zero based) and c is the column (zero based) on the
	 *         page.
	 */
	@Override
