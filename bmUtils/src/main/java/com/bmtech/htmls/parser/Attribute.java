...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/Attribute.java,v $
// $Author: liying $
...
public class Attribute implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3488516499110403403L;
	 ...
	 * the quote value is zero, assigns the value using {@link #setRawValue}
	 ...
	 * calls {@link #setRawValue} to get the correct quoting if
	...
	/**
	 * Set the name of this attribute. Set the part before the equals sign, or
	 * the contents of the stand-alone attribute. <em>WARNING:</em> Setting this
	 * to <code>null</code> can result in malformed HTML if the assignment
	...
	/**
	 * Set the value of the attribute. The part after the equals sign, or the
	 * text if it's a whitepace 'attribute'. <em>WARNING:</em> Setting this
	 * property to a value that needs to be quoted without also setting the
	 * quote character will result in malformed HTML.
	 * 
	 * @param value
	 *            The new value.
	 * @see #getValue
	 ...
	 * as the real value. Otherwise, examine the string to determine if quotes
	 * are needed and an appropriate quote character if so. This may involve
	...
	/**
	 * Get a text representation of this attribute. Suitable for insertion into
	 * a tag, the output is one of the forms: <code>
	 * <pre>
	 * value
	 * name
	 * name=
