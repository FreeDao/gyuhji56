...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/tags/AppletTag.java,v $
// $Author: liying $
...
/**
 * AppletTag represents an &lt;Applet&gt; tag. It extends a basic tag by
 * providing accessors to the class, codebase, archive and parameters.
 */
public class AppletTag extends CompositeTag {
	 ...
	 * 
	 * @return The list of applet parameters (keys and values are String
	 *         objects).
	 */
	 ...
	 * 
	 * @return The list of parameter values (keys and values are String
	 *         objects).
	 */
	 ...
	 * 
	 * @return The value of the <code>ARCHIVE</code> attribute, or
	 *         <code>null</code> if it wasn't specified.
	 */
	 ...
	 * 
	 * @return The value of the <code>CODEBASE</code> attribute, or
	 *         <code>null</code> if it wasn't specified.
	 */
	 ...
	 * @return The value of the parameter or <code>null</code> if there is no
	 ...
	 *         <code>PARAM<code> tag <code>NAME<code> attributes.
	 */
	...
	public void setAppletParams(Hashtable<?, ?> newAppletParams) {
		...
		for (Enumeration<?> e = newAppletParams.keys(); e.hasMoreElements();) {
			attributes = new Vector<Attribute>(); // should the tag copy the
													// attributes?
