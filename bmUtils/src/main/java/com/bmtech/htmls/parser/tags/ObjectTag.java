...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/tags/ObjectTag.java,v $
// $Author: liying $
...
/**
 * ObjectTag represents an &lt;Object&gt; tag. It extends a basic tag by
 * providing accessors to the type, codetype, codebase, classid, data, height,
 * width, standby attributes and parameters.
 */
public class ObjectTag extends CompositeTag {
	 ...
	 * 
	 * @return The list of object parameters (keys and values are String
	 *         objects).
	 */
