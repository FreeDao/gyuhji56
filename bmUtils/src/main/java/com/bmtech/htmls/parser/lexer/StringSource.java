...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/lexer/StringSource.java,v $
// $Author: liying $
...
public class StringSource extends Source {
	...
	/**
	 * The encoding to report. Only used by {@link #getEncoding}.
	 */
	...
	/**
	 * Construct a source using the provided string. Until it is set, the
	 * encoding will be reported as ISO-8859-1.
	 * 
	 * @param string
	 *            The source of characters.
	 */
	...
	/**
	 * Construct a source using the provided string and encoding. The encoding
	 * is only used by {@link #getEncoding}.
	 * 
	 * @param string
	 *            The source of characters.
	 * @param character_set
	...
	/**
	 * Set the encoding to the given character set. This simply sets the
	 * encoding reported by {@link #getEncoding}.
	 * 
	 * @param character_set
	 ...
	 *         <tt>0x00-0xffff</tt>), or {@link #EOF EOF} if the source is
	 *         exhausted.
	 * @exception IOException
	...
	/**
	 * Skip characters. <em>Note: n is treated as an int</em>
	 * 
	 * @param n
	 ...
	 * @exception IOException
	 *                If the source is closed or an attempt is made to read
	 *                beyond {@link #offset()}.
	 */
	@Override
	...
	/**
	 * Retrieve a string comprised of characters already read. Asking for
	...
	/**
	 * Append characters already read into a <code>StringBuilder</code>. Asking
	 * for characters ahead of {@link #offset()} will throw an exception.
	 * 
	 * @param buffer
	 ...
	 */
	@Override
	public void getCharacters(StringBuilder buffer, int offset, int length)
			throws IOException {
		if (null == mString)
			throw new IOException("source is closed");
		else {
