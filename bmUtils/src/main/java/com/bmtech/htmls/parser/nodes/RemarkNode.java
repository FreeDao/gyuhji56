...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/nodes/RemarkNode.java,v $
// $Author: liying $
...
public class RemarkNode extends AbstractNode implements Remark {
	...
	/**
	 * Sets the string contents of the node. If the text has the remark
	 * delimiters (&lt;!-- --&gt;), these are stripped off.
	 * 
	 * @param text
	...
	/**
	 * Print the contents of the remark tag. This is suitable for display in a
	 * debugger or output to a printout. Control characters are replaced by
	 * their equivalent escape sequence and contents is truncated to 80
	 * characters.
	 * 
