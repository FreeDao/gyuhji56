...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/util/NodeList.java,v $
// $Author: liying $
...
public class NodeList implements Serializable {
	...
	public NodeList extractAllNodesThatMatch(NodeFilter filter,
		...
		for (int i = 0; i < size; i++) {
			...
			if (recursive) {
				...
				if (null != children)
					ret.add(children
							.extractAllNodesThatMatch(filter, recursive));
			}
		}
	...
	/**
	 * Utility to apply a visitor to a node list. Provides for a visitor to
	 * modify the contents of a page and get the modified HTML as a string with
	 * code like this:
	 * 
	 * <pre>
