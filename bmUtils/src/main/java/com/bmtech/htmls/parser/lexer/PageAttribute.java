...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/lexer/PageAttribute.java,v $
// $Author: liying $
 ...
 * but 'lazy loaded' from the <code>Page</code> by providing the page and cursor
 * offsets into the page for the name and value. This is done for speed, since
...
public class PageAttribute extends Attribute {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3811734519703553108L;
	 ...
	 * 
	 * @param page
	 *            The page containing the attribute.
	 * @param name_start
	 ...
	 */
	public PageAttribute(Page page, int name_start, int name_end,
	 ...
	 * 
	 * @return The page used to construct this attribute, or null if this is
	 ...
	 * 
	 * @param page
	 *            The page to be used to construct this attribute. Note: If you
	 *            set this you probably also want to uncache the property values
	...
	public boolean isWhitespace() {
		return (((null == super.getName()) && (null == mPage)) || ((null != mPage) && (0 > mNameStart)));
	}
