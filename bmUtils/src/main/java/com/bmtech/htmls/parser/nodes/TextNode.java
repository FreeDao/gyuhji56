...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/nodes/TextNode.java,v $
// $Author: liying $
...
//import com.bmtech.utils.TagRemove_reg;
...
public class TextNode extends AbstractNode implements Text {
	...
	public String toHtml(boolean verbatim) {
		...
		ret = mText;
		if (null == ret)
			ret = removeEsc(mPage.getText(getStartPosition(), getEndPosition()));
