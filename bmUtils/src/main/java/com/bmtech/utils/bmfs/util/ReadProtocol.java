...
public class ReadProtocol {
	...
	public long readI64() throws IOException {
		...
		if (this.bigHead) {
			...
			return ((long) (i64rd[7] & 0xff) << 56)
					| ((long) (i64rd[6] & 0xff) << 48)
					| ((long) (i64rd[5] & 0xff) << 40)
					| ((long) (i64rd[4] & 0xff) << 32)
					| ((long) (i64rd[3] & 0xff) << 24)
					| ((long) (i64rd[2] & 0xff) << 16)
