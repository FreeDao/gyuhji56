...
public enum TokenType {
	...
	LESS_THEN("<", TokenClass.RELATION), LESS_EQUAL(">", TokenClass.RELATION), EQUAL("=",
			TokenClass.RELATION), GREATER_EQUAL(">=", TokenClass.RELATION), GREATER_THEN("<=",
					TokenClass.RELATION), NOT_EQUAL("!=", TokenClass.RELATION), SEARCH("search",
							TokenClass.RELATION), IS("is", TokenClass.RELATION), LIKE("like", TokenClass.RELATION), // Comparison
	// operators

	IN("IN", TokenClass.RELATION),

	NUMBER("@num", TokenClass.UNKNOWN), STRING_LITERAL("@str", TokenClass.UNKNOWN), TRUE("@true",
			TokenClass.UNKNOWN), FALSE("@false", TokenClass.UNKNOWN), // Constant
	// types

	VARIABLE("@variable", TokenClass.UNKNOWN),
	// FUNCTION("@function", TokenClass.UNKNOWN),
	ORDER("order", TokenClass.UNKNOWN), BY("by", TokenClass.UNKNOWN), LIMIT("limit", TokenClass.UNKNOWN), ASC("asc",
			TokenClass.UNKNOWN), DESC("desc", TokenClass.UNKNOWN), END_STATEMENT("@end",
					TokenClass.UNKNOWN), VALUEUNSET("?", TokenClass.NOTSETYET);
