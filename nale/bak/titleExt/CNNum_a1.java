...
public class CNNum_a1 extends SerialNumber{
	String[]nums = new String[]{
			"⑴","⑵","⑶","⑷","⑸","⑹","⑺","⑻","⑼","⑽","⑾","⑿","⒀","⒁","⒂","⒃","⒄","⒅","⒆","⒇","⑴","⑵","⑶","⑷","⑸","⑹","⑺","⑻","⑼","⑽","⑾","⑿","⒀","⒁","⒂","⒃","⒄","⒅","⒆","⒇"};
	final int realIntId;
	public CNNum_a1(String number, String prefix, String suffix) {
	...
	public SerialNumber next() {
		...
		return new CNNum_a1(nums[realIntId], this.prefix, this.suffix);
	}
	public static CNNum_a1 match(String line){
		...
		if(m.find()){
			...
			return new CNNum_a1(sNumber, fix[0], fix[1]);
		}
		return null;
	}
