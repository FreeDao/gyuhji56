package nale.script.engine.lang;

import java.io.StringReader;
import java.util.ArrayList;
import java.util.List;

import nale.script.engine.lang.ast.AssignAtNode;
import nale.script.engine.lang.ast.AssignNode;
import nale.script.engine.lang.ast.AssignableNode;
import nale.script.engine.lang.ast.BooleanNode;
import nale.script.engine.lang.ast.DebuggerNode;
import nale.script.engine.lang.ast.EchoNode;
import nale.script.engine.lang.ast.ExpNode;
import nale.script.engine.lang.ast.FunctionCallNode;
import nale.script.engine.lang.ast.IFEndNode;
import nale.script.engine.lang.ast.IFNode;
import nale.script.engine.lang.ast.NumberVariable;
import nale.script.engine.lang.ast.RegexExpressionNode;
import nale.script.engine.lang.ast.VarNode;
import nale.script.engine.lang.ast.itf.NaleNode;
import nale.script.engine.lang.ast.itf.ReferNode;
import nale.script.engine.lang.ast.itf.ValueNode;
import nale.script.engine.lang.regex.LiteralPartial;
import nale.script.engine.lang.regex.Regex;
import nale.script.engine.lang.regex.RegexExpression;
import nale.script.engine.lang.regex.VarsPartial;

import com.funshion.gamma.jmo.lang.JmoException;
import com.funshion.gamma.jmo.lang.ParseException;
import com.funshion.gamma.jmo.lang.source.CombinReader;
import com.funshion.gamma.jmo.lang.source.SourcePosition;
import com.funshion.gamma.jmo.lang.source.SourceReader;
...
public class LineParser {
	...
	private NaleNode assign(VarNode varNode, boolean isSharp)
		...
		if (isSharp) {
			...
			if (next.getType() == TokenType.TRUE) {
				buf.takeToken();
				return new AssignNode(buf.currentPosition(), varNode,
						new BooleanNode(true, next.getPosition()));
				...
				if (x == null) {
					...
					return new AssignNode(buf.currentPosition(), varNode,
							new NumberVariable(x, buf.currentPosition()));
				}
			}
		}
	...
	private NaleNode parseVariable() throws JmoException {
	...
	private List<ReferNode> funcParasNode() throws JmoException {
	...
	private VarNode varNode() throws JmoException {
		Token t = buf.findValid();
		checkType(t, null);
